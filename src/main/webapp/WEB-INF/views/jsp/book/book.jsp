...
<form:input path = "name" type = "text" class = "form-control" placeholder = "Name" required = "true"/><br>
<form:errors path="name" class="text-error" style = "color: red; font-weight: bold;"/>
</div>
<div class = "form-group">
